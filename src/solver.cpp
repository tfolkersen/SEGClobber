...
#ifdef PRINT_TTABLE_SIZE
    cout << "Transposition table entry size: " << tableEntrySize << " bytes"
         << endl;

    const double size_mb = ((double) tableSize) / (1000.0 * 1000.0);
    cout << "Total size of table: " << size_mb << " MB" << endl;
    exit(0);
#endif
